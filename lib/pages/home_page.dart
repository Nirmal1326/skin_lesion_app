...
class _CameraAppState extends State<CameraApp> {
  ...
  final ImageClassificationService imageClassificationHelper =
  ...
  Future<void> _classifyImage() async {
    ...
    try {
      final results =
          await imageClassificationHelper.classifyImage(_selectedImage);
  ...
  void _showClassificationResultDialog(List<double> classificationResults) {
    highestClassIndex = classificationResults
        .indexOf(classificationResults.reduce((a, b) => a > b ? a : b));
    highestClass = skinClasses[highestClassIndex];
            ...
            children: [
              ...
              Text(
                classificationResults
                    .map((score) => score.toStringAsFixed(5))
                    .join(', '),
              ),
  ...
  Widget _buildCroppedImage() {
    if (_selectedImage != null) {
      ...
      return const Center(
          child: Text('Upload an image or take a picture to get started.'));
    }
  }
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          ...
          final snackBar = SnackBar(
            content: const Text('Update coming soon'),
